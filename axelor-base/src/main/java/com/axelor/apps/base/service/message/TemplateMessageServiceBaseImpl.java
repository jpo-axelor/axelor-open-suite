...
public class TemplateMessageServiceBaseImpl extends TemplateMessageServiceImpl {
  ...
  public Set<MetaFile> getMetaFiles(
    ...
    Set<MetaFile> metaFiles = super.getMetaFiles(template, templates, templatesContextMap);
    ...
    metaFiles.add(
        createMetaFileUsingBirtTemplate(
            templates, templatesContextMap, template.getBirtTemplate()));
  ...
  public MetaFile createMetaFileUsingBirtTemplate(
      Templates templates, Map<String, Object> templatesContextMap, BirtTemplate birtTemplate)
      throws AxelorException, IOException {
  ...
  public File generateBirtTemplate(
    ...
    ReportSettings reportSettings =
        generateTemplate(
            templates, templatesContextMap, fileName, modelPath, format, birtTemplateParameterList);
  ...
  private ReportSettings generateTemplate(
    ...
    for (BirtTemplateParameter birtTemplateParameter : birtTemplateParameterList) {
      ...
      try {
        String parseValue =
            templates.fromText(birtTemplateParameter.getValue()).make(templatesContextMap).render();
